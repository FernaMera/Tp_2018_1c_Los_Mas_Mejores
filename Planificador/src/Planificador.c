...
int main(void)
{
	...
	{    
       ...
       // pthread_mutex_lock(&console_mutex);
        ...
        log_info(logger, "Instruction Completed");
...
void calculate_estimation(t_esi* esi_a_estimar)
{
    ...
    float cpu = esi_a_estimar->cpu_time_previous;
    ...
    esi_a_estimar->cpu_time_previous = nueva_estimacion;
